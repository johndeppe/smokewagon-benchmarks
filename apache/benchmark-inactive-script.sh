...
do
    ...
    echo hey
    taskset -c 57-63 /home/milkv/go/bin/hey -disable-keepalive -z 10s http://localhost/index.html > /home/milkv/sophgo/smokewagon-benchmarks/apache/results/hey-output-inactive-$(printf '%02d' "$i").txt
